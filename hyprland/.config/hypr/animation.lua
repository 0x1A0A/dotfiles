...
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 1.94, spring = "easy", style = "slidevert" })
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 16, bezier = "quick" })
